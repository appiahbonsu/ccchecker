                        ...
                        <div class="uk-article-content">
                            <?php if ($_SESSION['roles'] === 'admin') { ?>
                                ...
                                <div class="uk-card uk-card-category hyper_mt uk-card-default uk-card-hover uk-card-body uk-inline uk-border-rounded uk-width-1-1">
                                 ...
                                 <!-- card one  -->
                                 <div class="uk-card uk-card-category hyper_mt uk-card-default uk-card-hover uk-card-body uk-inline uk-border-rounded uk-width-1-1">
                                    <a class="uk-position-cover" href="./active?_utm_source=pending"></a>
                            ...
                            ?>
                                ...
                                <p class="uk-text-lead uk-text-muted">Once the site admin approve your account you can use Team 2.0.</p>
