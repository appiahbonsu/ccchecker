...
<div id="offcanvas-docs" data-uk-offcanvas="overlay: true">
  <div class="uk-offcanvas-bar">
    ...
    <ul class="uk-nav uk-nav-default doc-nav">
      <li class="uk-active"><a href="https://t.me/namelessxl">Join Group</a></li>
      <li><a href="https://t.me/namelessxl">Join Channel</a></li>
    </ul>
...
<div id="offcanvas" data-uk-offcanvas="flip: true; overlay: true">
  <div class="uk-offcanvas-bar">
    <a class="uk-logo" href="index.php">Team 2.0</a>
    <button class="uk-offcanvas-close" type="button" data-uk-close></button>
    <ul class="uk-nav uk-nav-primary uk-nav-offcanvas uk-margin-top uk-text-center">
      <li ><a href="./">Home</a></li>
      <li ><a href="https://t.me/BonsuAppiah">Support</a></li>
...
<footer class="uk-section uk-text-center uk-text-muted">
	<div class="uk-container uk-container-small">
		...
		<div class="uk-margin-medium uk-text-small uk-link-muted">This Checker Was Created By <a  
				href="https://t.me/BonsuAppiah">Appiah Bonsu</a></div>
	</div>
</footer>